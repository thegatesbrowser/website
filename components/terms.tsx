export default function TermsOfService() {
  return (
    <main className="bg-background">
      <section className="relative overflow-hidden border-b border-border/60 bg-card/40 py-16 sm:py-20">
        <div className="absolute inset-0 -z-10">
          <div
            className="absolute bottom-0 left-1/2 h-56 w-[36rem] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"
            aria-hidden
          />
        </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-4xl space-y-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-10">
            ...
            <article className="space-y-4">
              <h2 className="text-xl font-semibold text-foreground">2. Ownership and Intellectual Property</h2>
            ...
            <article className="space-y-4">
              ...
              <ul className="list-disc space-y-3 pl-6 text-base leading-relaxed text-foreground/70">
                <li>
                  You are responsible for the content you upload, including ensuring it does not violate any laws,
                  copyrights, or third-party rights.
                </li>
                <li>You agree not to upload or distribute any content that is harmful, illegal, infringing, or malicious.</li>
                <li>
                  You are responsible for managing your backups; while we aim for reliability, we cannot guarantee
            ...
            <article className="space-y-4">
              ...
              <ul className="list-disc space-y-3 pl-6 text-base leading-relaxed text-foreground/70">
                ...
                <li>Impersonate others or misrepresent your project’s origin.</li>
                <li>Upload content that promotes hate, violence, or discrimination.</li>
              </ul>
            </article>
            ...
            <article className="space-y-4">
              ...
              <p className="text-base leading-relaxed text-foreground/70">
                You may stop using the service or delete your content at any time. We may suspend or terminate access if:
              </p>
              <ul className="list-disc space-y-3 pl-6 text-base leading-relaxed text-foreground/70">
              ...
              <p className="text-base leading-relaxed text-foreground/70">
                Upon termination, your hosted projects and associated data may be deleted.
              </p>
            </article>
            ...
            <article className="space-y-4">
              ...
              <p className="text-base leading-relaxed text-foreground/70">
                If you have any questions about these Terms or how your content is handled, please contact us at{' '}
                <a href="mailto:thegates.browser@gmail.com" className="text-primary hover:underline">
